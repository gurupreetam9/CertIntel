                        ...
                        <div className="border rounded-lg">
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        <TableHead>
                                            <Button variant="ghost" size="sm" onClick={() => requestSort('studentName')} className="p-0">
                                                Student Name
                                        ...
                                        <TableHead>
                                            <Button variant="ghost" size="sm" onClick={() => requestSort('studentRollNo')} className="p-0">
                                                Roll No.
